  ...
  if (numused) {
    ...
    // Remember that light positions must be transformed by modelview.
      ...
      for (int i = 0; i < numused; i++) {
          GLfloat oldLight[4] = { lightposn[(i * 4)], lightposn[(i * 4) + 1], lightposn[(i * 4) + 2], lightposn[(i * 4) + 3] };
          GLfloat newLight[4];
          
          transformvec(oldLight, newLight);
          
          lightransf[(i * 4)] = newLight[0];
          lightransf[(i * 4) + 1] = newLight[1];
          lightransf[(i * 4) + 2] = newLight[2];
          lightransf[(i * 4) + 3] = newLight[3];
      }
